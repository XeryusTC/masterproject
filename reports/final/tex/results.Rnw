...
\begin{table}[t]
	...
	\begin{tabular}{l|r|r|r}
        \hline
		& \multicolumn{3}{c}{Weights} \\ \cline{2-4}
...
<<perfgraph,echo=F,warning=F,cache=T,dependson='preprocess',dev='tikz',fig.height=3,fig.width=6,fig.align='center',fig.pos='h',fig.cap=perfgraph.title>>=
plot(c(), c(),
    type='l',
    log='y',
    col='red',
