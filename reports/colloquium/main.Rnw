...
\begin{frame}{Deliberation Dialogues}
    ...
    argumentative multi-agent system.
    \begin{itemize}
...
\begin{frame}{Multi-agent Coordination}
    \begin{itemize}
        \item Decentralized planning can be achieved using Partial Global 
        Planning
...
\begin{frame}{WDPCA*}
    ...
    \begin{itemize}
        \item Computation is done up front
