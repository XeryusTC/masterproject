...
ALGORITHMS = [
    ...
    Algorithm('Base', version1_entry,
              {'weights': Weights(2.829776, 5.302586, 1)}),
    Algorithm('Plus', version1b_entry,
              {'weights': Weights(9.087389, 2.610796, 13.137686)}),
    Algorithm('Window8', window_entry,
              {'window_size': 8, 'weights': Weights(7.092043, 10.688095, 1)}),
    Algorithm('Window4', window_entry,
              {'window_size': 4, 'weights': Weights(1.794858, 17.680828, 1)}),
    Algorithm('Window2', window_entry,
              {'window_size': 2, 'weights': Weights(2.266400, 5.654299, 1)}),
