...
\[ \langle a_2, a_3, \ldots, a_n, a_1 \rangle \]
\[ \vdots \]
\[ \langle a_n, a_1, \ldots a_{n-2}, a_{n-1} \rangle \]
...
conflicting paths. So when the algorithm evaluates \[ \langle a_1, a_2, \ldots,
a_{n-1}, a_n \rangle \] and fails to find a solution it will not have to
