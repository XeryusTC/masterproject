...
WDPCA* is based on the A* algorithm \citep{hart1968} but this can be changed to
...
%Deliberation dialogue models are complex. \citep{mcburney2007} has 8 stages,
%most of which aren't used here. Instead \citep{dunin-keplicz2011} is used for
%simplicity. It is verbose enough for this purpose but \citep{mcburney2007} may
%be more appropriate for more complex applications (think planning trains),
%\citep{walton2014} may be appropriate then too. \citep{mcburney2007,walton2014}
