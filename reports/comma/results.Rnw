...
<<perfgraph,echo=F,warning=F,cache=T,cache.beater=dat,dev='tikz',fig.height=1.6,fig.width=5,fig.align='center',fig.pos='t',fig.cap=perfgraph.title>>=
...
<<solved,echo=F,cache=T,cache.beater=solved.aggr,dev='tikz',fig.width=5,fig.height=1.6,fig.align='center',fig.pos='t',fig.cap=solved.title>>=
...
<<lengths,echo=F,warning=F,cache=T,cache.beater=dat.lengths,dev='tikz',fig.width=5,fig.height=1.6,fig.align='center',fig.pos='t',fig.cap=lengths.title>>=
op <- par(mar = c(3.8, 3.8, 1, 1))
plot(c(),
     type='n',
     xlim=c(5,40),
...
<<dialogues,echo=F,cache=T,cache.beater=conflicts.aggr,dev='tikz',fig.width=5,fig.height=1.6,fig.align='center',fig.pos='t',fig.cap=conflicts.title>>=
op <- par(mar = c(4, 3.8, 1, 1))
plot(1,
    type='l',
    xlim=c(0,40),
...
<<conflict-sizes,echo=F,cache=T,cache.beater=sizes.aggr,dev='tikz',fig.width=5,fig.height=1.6,fig.align='center',fig.pos='t',fig.cap=sizes.title>>=
op <- par(mar = c(4, 3.8, 1, 1))
plot(1,
    type='n',
    xlim=c(1,40),
...
<<cache,echo=F,warning=F,cache=T,cache.beater=dat.cache,dev='tikz',fig.width=5,fig.height=1.5,fig.align='center',fig.pos='t',fig.cap=cachegraph.title>>=
op <- par(mar = c(3.8, 3.8, 1, 1))
plot(c(), c(),
     type='l',
     log='y',
...
does decrease the time required to find a solution. Using the path cache also 
