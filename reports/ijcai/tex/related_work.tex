...
Standley~\shortcite{standley2010} found that the runtime is dominated by 
finding a solution 
...
% Argumentation
Methods of multi-agent coordination have been developed by the field of
...
Pollock~\shortcite{pollock1995} has constructed an agent called OSCAR which is 
...
Walton and Krabbe~\shortcite{walton1995} proposed a typology of the six main 
dialogues 
...
Walton~\emph{et al.}~\shortcite{walton2014}. It 
