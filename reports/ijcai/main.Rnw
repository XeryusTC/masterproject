...
Bart Verheij$^1$
\\
$^1$ Artificial Intelligence and Cognitive Engineering, University
of Groningen \\
brontitall@dds.nl,
bart.verheij@rug.nl
}
...
problem instances."
cachegraph.title = "Comparison of DPCA* performance with the path cache enabled 
(solid line) and the cache disabled (dashed line)."
