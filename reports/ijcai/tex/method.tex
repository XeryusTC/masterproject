...
can be used to solve the problem \citep{latombe1991,bennewitz2002}. This means
...
Cooperative A* (CA*). This algorithm is a variation on A* \citep{hart1968} that
...
of implied Independence Detection \citep{standley2010} because these agents will
