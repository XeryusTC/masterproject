...
work in a multi-agent system. \emph{Assertions} are used as post- and
preconditions to switch between planning and execution. During the planning
stage an agent will postpone creating a plan for a sub-problem and create an
assertion instead. At this point the agent can start executing the plan. When
...
constraints that may have been imposed on them. Continual Planning has been
...
finding a new partial plan when conflicts arise is faster. This comes at the
